...
cred = credentials.Certificate("lc-project-b2832-firebase-adminsdk-1itgr-9736c70286.json")
firebase_admin.initialize_app(cred, {'databaseURL':'https://lc-project-b2832-default-rtdb.europe-west1.firebasedatabase.app/'})
